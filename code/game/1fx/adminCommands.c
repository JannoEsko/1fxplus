...
{
    /*
    {"!adr",    "adminremove",      &minimumAdmLevel,           &adm_adminRemove,               "Remove an Admin from the list",    "<line #>",         NULL,qtrue},
    {"!adl",    "adminlist",        &g_adminlist.integer,       &adm_adminList,                 "Show the Adminlist",               "",                 NULL,qtrue},
    {"!al",     "adminlist",        &g_adminlist.integer,       &adm_adminList,                 "Show the Adminlist",               "",                 NULL,qtrue},
    {"!ab",     "addbadmin",        &g_badmin.integer,          &adm_addAdmin,                  "Basic Admin",                      "<i/n>",            NULL,qtrue},
    {"!aa",     "addadmin",         &g_admin.integer,           &adm_addAdmin,                  "Admin",                            "<i/n>",            NULL,qtrue},
    {"!as",     "addsadmin",        &g_sadmin.integer,          &adm_addAdmin,                  "Server Admin",                     "<i/n>",            NULL,qtrue},
