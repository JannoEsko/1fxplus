...
int     goldbg_numItems = sizeof(goldbg_itemlist) / sizeof(goldbg_itemlist[0]) - 1;
int     silverbg_numItems = sizeof(silverbg_itemlist) / sizeof(silverbg_itemlist[0]) - 1;
